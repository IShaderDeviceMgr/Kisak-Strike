...
//-----------------------------------------------------------------------------
class CShaderDeviceMgrMTL : public CShaderDeviceMgrBase
{
...
extern CShaderDeviceMgrMTL* g_pShaderDeviceMgrDx8;
...
//-----------------------------------------------------------------------------
class CShaderDeviceMTL : public CShaderDeviceBase
{
	// Methods of IShaderDevice
public:
...
protected:
	...
	MTL::Device* InvokeCreateDevice( void* hWnd, int nAdapter, DWORD deviceCreationFlags );

	// Checks for CreateQuery support
	void DetectQuerySupport( MTL::Device* pD3DDevice );
...
protected:
...
#ifdef _X360
	CON_COMMAND_MEMBER_F( CShaderDeviceMTL, "360vidinfo", SpewVideoInfo360, "Get information on the video mode on the 360", 0 );
#endif
	...
	MTL::Texture	*m_pFrameSyncTexture;
	...
	friend class CShaderDeviceMgrMTL;
...
extern CShaderDeviceMTL* g_pShaderDeviceDx8;
...
FORCEINLINE bool CShaderDeviceMTL::IsDeactivated() const 
{ 
