...
#ifndef SHADERSHADOWMTL_H
#define SHADERSHADOWMTL_H
...
//-----------------------------------------------------------------------------
abstract_class IShaderShadowMTL : public IShaderShadow
{
public:
	// Initializes it
	virtual void Init() = 0;
	...
	static IShaderShadowMTL* Create( IShaderAPIMTL* pShaderAPIMTL );
	static void Destroy( IShaderShadowMTL* pShaderShadow );
};

extern IShaderShadowMTL *g_pShaderShadowMTL;

#endif // SHADERSHADOWMTL_H
